...
/**
 * Servlet implementation class DoctorPrescriptionList
 */
@WebServlet("/prescriptionlist")
public class DoctorPrescriptionList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("preslist", newpresList);
